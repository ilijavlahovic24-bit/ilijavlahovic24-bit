...
|---|---|---|---|---|
| [Fault-Tolerant Distributed File System]([https://github.com/ilijavlahovic24-bit](https://github.com/ilijavlahovic24-bit/ffs)) | Distributed FS with FUSE mount, WAL for crash recovery, Raft consensus (planned) | Rust, FUSE, Tokio | In Progress | Systems Software |
